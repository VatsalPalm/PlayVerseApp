...
import type { QueryOperation } from "./stackApiComponents";

export type StackApiContext<
 ...
 */
export function useStackApiContext<
  TQueryFnData = unknown,
  TError = DefaultError,
  TData = TQueryFnData,
  TQueryKey extends QueryKey = QueryKey,
>(
  _queryOptions?: Omit<
    ...
    "queryKey" | "queryFn"
  >,
): StackApiContext<TQueryFnData, TError, TData, TQueryKey> {
  return {
    fetcherOptions: {},
    queryOptions: {},
  };
